...
class Config(object):
    ...
    PASSWORD = os.environ.get("PASSWORD","despacito")
    DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://despacito:despacito@cluster0.ksuipi2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
